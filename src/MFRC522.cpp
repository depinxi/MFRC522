...
#	define RSTPIN 5    // GPIOG9 -> see `gpio realall`, column wPi
#	define SPI_CHAN    0
#	define SPI_SPEED   4000000

#endif

const byte MFRC522::FIFO_SIZE = 64;
...
#endif // MFRC522_DEVICE_FAMILY_PI
                              ...
                              )
{
	...
	byte *buffer = (byte *)malloc((count + 1) * sizeof(byte));
 ...
 */
const MFRC522_STRING_TYPE MFRC522::GetStatusCodeName(MFRC522::StatusCode code	///< One of the StatusCode enums.
                                                     )
{
 ...
 * @return const MFRC522_STRING_TYPE
 */
const MFRC522_STRING_TYPE MFRC522::PICC_GetTypeName(PICC_Type piccType	///< One of the PICC_Type enums.
                                                    )
{
